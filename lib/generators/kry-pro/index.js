      ...
      filterFiles: f => {
        ...
        if (isTypeScript) {
          ...
          if (!reactFeatures.includes('pont')) {
            if (f.startsWith('pont-config.json') || f === 'template.ts' || f === 'serviceTemplate.ts') return false;
          }
        } else {
          ...
          if (!reactFeatures.includes('pont')) {
            if (f.startsWith('pont-config.json') || f === 'template.js' || f === 'serviceTemplate.js') return false;
          }
        }
        return true;
      },
