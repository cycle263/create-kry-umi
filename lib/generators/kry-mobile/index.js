    ...
    if (this.opts.args && 'isTypeScript' in this.opts.args && 'reactFeatures' in this.opts.args) {
      ...
      const prompts = [
        ...
        },
        {
          ...
          type: 'checkbox',
          choices: [
            {name: 'antd-mobile', value: 'antd-mobile'},
            {name: 'dva', value: 'dva'},
          ...
          default: ['antd-mobile', 'dva', 'dynamicImport', 'dll', 'locale', 'pont'],
        },
      ];
      ...
      filterFiles: f => {
        ...
        if (isTypeScript) {
          ...
          if (!reactFeatures.includes('pont')) {
            if (f.startsWith('pont-config.json') || f === 'pontTemplate.ts' || f === 'serviceTemplate.ts') return false;
          }
        } else {
          ...
          if (!reactFeatures.includes('pont')) {
            if (f.startsWith('pont-config.json') || f === 'pontTemplate.js' || f === 'serviceTemplate.js') return false;
          }
        }
        return true;
      },
